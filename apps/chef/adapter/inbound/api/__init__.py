...
from chef.adapter.inbound.api.v1.receiver_router import receiver_router
...
from chef.adapter.inbound.api.v1.watcher_router import watcher_router

chef_router = APIRouter(prefix="/chef", tags=["chef"])
chef_router.include_router(email_router)
chef_router.include_router(receiver_router)
...
chef_router.include_router(watcher_router)

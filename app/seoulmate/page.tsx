...
export default function SeoulMatePage() {
  ...
  return (
    <main className="min-h-[calc(100dvh-var(--site-header-height))] bg-background px-6 pb-16 pt-6">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="flex w-full items-center justify-between gap-3 px-4 py-4 text-left transition hover:bg-secondary"
                ...
                {isOpen && (
                  <div className="border-t border-border bg-muted/80 px-4 py-4">

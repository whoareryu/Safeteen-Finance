...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--base-model",
        default="/home/bob/projects/cloud.whoareryu/fastapi/Qwen--Qwen2.5-1.5B-Instruct/snapshots/989aa7980e4cf806f80c7fef2b1adb7bc71aa306",
        help="베이스 모델 로컬 경로 또는 HF repo id",
    )

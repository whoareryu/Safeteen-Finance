...
// www/lib/plant-labels.ts와 동일한 매핑을 유지한다. 매핑에 없는 값은 원문 그대로 보여준다.

const Map<String, String> _speciesKo = {
...
const Map<String, String> _symptomKo = {
  'healthy': '건강함(Healthy)',
  'not_assessed': '증상 미판정',
  'rust': '녹병(Rust)',
  'scab': '검은별무늬병(Scab)',
...
String translateSpecies(String raw) => _speciesKo[raw] ?? raw;

String translateSymptom(String raw) => _symptomKo[raw] ?? raw;

const Map<String, String> stageEmoji = {
  '새싹': '🌱',
  '새순': '🌿',
  '성목': '🌳',
};

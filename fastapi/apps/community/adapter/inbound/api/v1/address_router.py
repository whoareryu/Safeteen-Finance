...
from community.adapter.inbound.api.schemas.address_schema import (
    AddressCreateRequest,
    AddressDetailResponse,
    AddressUploadResultSchema,
    ContactUploadSchema,
)
from community.app.dtos.address_dto import AddressCreateCommand, AddressQuery, ContactUploadDto
from community.app.ports.input.address_use_case import AddressUseCase
from community.dependencies.address_provider import get_address_use_case

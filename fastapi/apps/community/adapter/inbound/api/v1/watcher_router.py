...
from community.adapter.inbound.api.schemas.watcher_schema import ClassifyRequest, ClassifyResponse
from community.app.dtos.watcher_dto import ClassifyCommand, WatcherQuery

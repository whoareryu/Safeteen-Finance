...
from community.adapter.inbound.api.schemas.discord_schema import DiscordSchema
from community.app.dtos.discord_dto import DiscordMessageCommand, DiscordMessageResult, DiscordQuery, DiscordResponse
